...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //validation
  //check if user is already existed : username , email
  ...
  if (!createdUser) {
    throw new ApiError(500, "something went wrong wile regestering the user");
  }
...
const loginUser = asyncHandler(async (req, res) => {
  //get user details from frontend : username and password
  //validate if the details are provided
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  if (!avatarLocalPath) {
    throw new ApiError(400, "The avatar local file path is not available");
  }
...
//------------------------------------------------------------------------
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, user, "The user avatar file is updated successfully")
    );
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user,
        "The user cover image url is updated successfully"
      )
    );
});
